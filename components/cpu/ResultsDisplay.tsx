  ...
  if (!results) {
    return (
      <div className="p-6 bg-white dark:bg-slate-800 rounded-lg shadow-lg text-center min-h-[300px] flex flex-col justify-center items-center">
        ...
        <p className="text-slate-600 dark:text-slate-300">Run a CPU scheduling simulation to see the results.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 bg-white dark:bg-slate-800 rounded-lg shadow-lg space-y-6">
      ...
      <div>
        ...
        <div className="flex space-x-1 sm:space-x-2 mb-4 border-b border-slate-200 dark:border-slate-700 pb-2 overflow-x-auto">
        ...
        <div className="p-1 sm:p-4 border border-slate-200 dark:border-slate-700 rounded-md min-h-[200px]">
