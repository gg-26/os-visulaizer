...
import { PageAlgorithmOption } from '../../types';

interface PageAlgorithmExplanationProps {
  selectedAlgorithm: PageAlgorithmOption | undefined;
}

const PageAlgorithmExplanation: React.FC<PageAlgorithmExplanationProps> = ({ selectedAlgorithm }) => {
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-2 flex items-center">
            <i className="fas fa-brain mr-2 text-purple-500 dark:text-purple-400"></i> Concept
          </h3>
...
export default PageAlgorithmExplanation;
